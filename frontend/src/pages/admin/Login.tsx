      ...
      if (authService.isAuthenticated()) {
        try {
          ...
          if (user && user.is_admin) {
            // Si déjà connecté et admin, rediriger vers le dashboard
            navigate('/admin/dashboard');
          }
        } catch (error) {
          // En cas d'erreur, déconnecter et permettre la connexion
          authService.logout();
        }
      }
    };
    ...
    try {
      ...
      if (user && user.is_admin) {
        ...
        setTimeout(() => {
          ...
          // Utiliser navigate pour une redirection plus propre
          navigate('/admin/dashboard');
        }, 500);
      } else {
