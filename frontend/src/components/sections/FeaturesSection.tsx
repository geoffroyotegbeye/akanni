         ...
         <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border border-slate-200 animate-in fade-in-0 slide-in-from-bottom-4 duration-700 delay-300">
           ...
           <div className="grid md:grid-cols-2 gap-8 mb-12">
             ...
             <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
               ...
               <div className="text-lg text-center bg-orange-100 text-orange-800 px-2 py-0.5 rounded-full">ou <span className="font-bold">100 000 FCFA</span> les 4 mois (-17%)</div>
               <ul className="space-y-2 text-slate-700">
                 <li className="flex items-center gap-2">
